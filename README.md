### Critical learning theory: on the hidden curriculum
...
![Frankfurt School picture, on the left two old bald white men dressed in suits shake hands, right an old white man relaxes in a lawnchair holding a cigar.](../images/frankfurt_school.png "Left image: Max Horkheimer and Theodor Adorno in Heidelberg in 1964 at the Max Weber Institute of Sociology. Right image: Herbert Marcuse in Newton, Massachusetts in 1955. Source: Wikipedia")
...
Within the realm of **Critical Learning Theory**, the concept of **Hidden Curriculum**, extensively explored by Giroux, refers to the implicit messages, values, and norms transmitted through the informal aspects of the educational system, distinct from the explicit and planned syllabus ({% cite Giroux1988 %}).
